...
// Demo mode: session/login not needed
...
class _MemberDashboardScreenState extends State<MemberDashboardScreen> {
  ...
  void initState() {
    ...
    try {
      ...
      // Demo mode: ignore invalid data errors
    }
  }
  ...
  Future<void> _refreshMember() async {
    ...
    try {
      ...
      // Demo mode: skip session persistence
  ...
  Widget build(BuildContext context) {
    try {
      ...
      // Demo mode: logout just reloads the page
      Future<void> handleLogout() async {
        if (!context.mounted) return;
        Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(
              builder: (_) => const MemberDashboardScreen(member: {
